...
class LOOS_HCB {
	...
	private function add_hooks() {
		...
		add_action( 'wp_head', function() {
			...
			/* Font size */
			$hcb_style .= '.hcb_wrap pre.prism{font-size: '. LOOS_HCB::$settings['fontsize_pc'] .'}'.
			...
			if ( LOOS_HCB::$settings[ 'show_lang' ] === 'off' ) {
				$hcb_style .= '.hcb_wrap pre:not([data-file]):not([data-show-lang])::before{ content: none;}';
			}
		...
		add_action( 'admin_head', function() {
			...
			/* Code Lang */
			if ( LOOS_HCB::$settings[ 'show_lang' ] === 'off' ) {
				$hcb_style .= '.hcb-block:not([data-file]):not([data-show-lang])::before{ content: none;}';
			}
